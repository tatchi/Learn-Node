...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    var isHearted = _this.heart.classList.toggle('heart__button--hearted'); //this.heart is te button with the name="heart" (from the form)
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    // used to autofit the zoom level
...
function typeAhead(search) {
  ...
  var searchResutls = search.querySelector('.search__results');
  ...
  searchInput.on('input', function (e) {
    ...
    _axios2.default.get('api/search?q=' + value).then(function (res) {
      if (res.data.length) {
        ...
        searchResutls.innerHTML = (0, _dompurify2.default)(html);
        return;
      }
      searchResutls.innerHTML = (0, _dompurify2.default)('<div class="search__result">Not result found for ' + value + ' found!</div>');
    }).catch(function (err) {
      console.log(err);
    });
  });
